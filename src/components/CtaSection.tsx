    ...
    <section className="relative z-10 border-y border-zinc-800/60 bg-[#06070a]">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#06070a] via-[#06070a]/70 to-transparent"></div>
          <div className="absolute inset-0 bg-gradient-to-t from-[#06070a] via-transparent to-[#06070a]/40"></div>
