        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-x-6 gap-y-10 lg:gap-8 mb-10 md:mb-16">
          ...
          <div className="hidden md:flex col-span-1 lg:col-span-2 flex flex-col">
            ...
            <div className="flex flex-col gap-4 mt-2">
              ...
              <Link href={leadData.slug === "default" ? "/contact" : `/${leadData.slug}/contact`} className={`text-zinc-400 text-[14px] font-light ${leadData.slug === "default" ? "hover:text-amber-500" : ""} transition-colors`} style={{ "--hover-color": leadData.slug === "default" ? "" : leadData.primaryColor } as React.CSSProperties}>Contact</Link>
            </div>
          </div>
